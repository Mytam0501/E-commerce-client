<template>
    <div class="container">
        <div class="d-flex flex-row space-between">
            <img src="../assets/img/banner-mega.jpg" alt="">
        </div>
        <div class="banner">
            <p class="name">MEGA</p>
            <p><a href="/">HOME</a> > <a href="/mega">MEGA</a></p>
        </div>
        <div class="main d-flex flex-row space-between">
            <div class="category d-flex flex-column flex-start">
                <div>
                    <p class="title">PRODUCT CATEGORIES</p>
                    <p class="product-line"><a href="/mega/category/search?q=fragrance">Fragrance</a></p>
                    <p class="product-line"><a href="/mega/category/search?q=makeup">Makeup</a></p>
                    <p class="product-line-child"><a href="/mega/category/search?q=eye">Eye Palettes</a></p>
                    <p class="product-line-child"><a href="/mega/category/search?q=hair">Hair Health</a></p>
                    <p class="product-line-child"><a href="/mega/category/search?q=lips">Lips Gloss</a></p>
                    <p class="product-line"><a href="/mega/category/search?q=skincare">Skincare</a></p>
                </div>
                <div>
